<?php	
	...
	foreach($categories_home as $category_home) :
		...
		<?php
		global $post;
		$args_home = array( 'numberposts' => 1, 'offset'=> 0, 'orderby' => 'post_date', 'order' => 'ASC', 'category' => $category_home->cat_ID);
						...
						<a href="<?php the_permalink() ?>" title="<?php the_title(); ?>">						
							<div class="thumb-text">
								<?php
									...
									if($image != ''){ ?>
										<img width="600" height="440" src="<?php echo $image; ?>" alt="" class="alignleft"/>
									<?php }
								?>
